...
console.log(`Mahi Mahal\nWelcome to our restaurant`);
console.log("Ek Baar Khaoge to Baar - Baar Aaoge");
console.log(
  "Choose your day:- \n1:-Monday \n2:-Tuesday \n3:-Wednesday \n4:-Thursday \n5:-Friday \n6:-Saturday \n7:-Sunday"
);
  ...
  if (time == "1") {
    ...
    if (food == "1") {
      ...
      if (quantity == "1") {
        ...
        if (cost == 50) {
          ...
          let payback = cost - 50;
          console.log(
            `please take your return  ${payback},Thank you, Enjoy your food.`
          );
        } else {
          let want = 50 - cost;
          ...
          if (paymore == want) {
            ...
            console.log(
              `Take your extra money ${giveback} \nEnjoy Your Food \nThanks for Visit!!`
            );
          } else {
      ...
      console.log(
        `How many sandwich do you like to take? \n2 Pieces -- Rs.20 \n4 Pieces -- Rs.40`
      );
    ...
    if (food == "1") {
      ...
      if (quantity == "1") {
        ...
        if (quantity == "2") {
          ...
          if (cost == 300) {
            ...
            console.log(
              `Take your extra rupees ${payback} and enjoy your food`
            );
          } else {
            let want = 300 - cost;
            console.log(`please pay more ${want}`);
      ...
      if (quantity == "1") {
        ...
        if (cost == 399) {
          console.log(
            "Your order will be prepapred soon \n Thanks for Visit!!"
          );
        } else if (cost > 399) {
    ...
    if (food == "1") {
      ...
      if (quantity == "1") {
        ...
        console.log(
          "You have to pay Rs.249 for half plate Matar-Paneer +  Rice"
        );
        let pay = Number(prompt("Enter >> "));
        if (pay == 249) {
          console.log("Enjoy you dinner \nThanks for visit!!");
